...
{
    public partial class frmSAPApplication : Form
    {
        ...
        public frmSAPApplication(IApplication app)
        {
            //frmSAPWorkspace();
            InitializeComponent();
            iApp = app;
        ...
        public frmSAPApplication(IApplication app, string file_name)
        {
            //frmSAPWorkspace();
            InitializeComponent();
            iApp = app;
        ...
        vdLayer solidsLay { get; set; }
         ...
         ASTRADoc AST_DOC { set; get; }
         SAP_Document SAP_DOC { set; get; }
        ...
        private void frmSAPApplication_FormClosing(object sender, FormClosingEventArgs e)
        {
