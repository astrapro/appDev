...
namespace AstraAccess
{
    public partial class frmSAP_Editor : Form
    {
        ...
        public frmSAP_Editor(IApplication app)
        {
            //frmSAP_Editor();
            InitializeComponent();
            iApp = app;
        ...
        public frmSAP_Editor(IApplication app, string file_name)
        {
            //frmSAP_Editor();
            InitializeComponent();
            iApp = app;
        ...
        private void frmSap_Editor_Load(object sender, EventArgs e)
        {
