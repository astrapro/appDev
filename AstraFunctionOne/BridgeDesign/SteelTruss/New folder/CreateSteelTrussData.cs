    ...
    public class CreateSteel_Warren_1_TrussData
    {
        ...
        public bool CreateData(string fileName)
        {
            try
            {
                ...
                list.Add("ASTRA SPACE FRAME WITH TRUSS DEAD LOAD+SIDL+MOVING LOAD");
                list.Add("UNIT KN MET");
                //list.AddRange(GetJointCoordinates());
                list.AddRange(Get_Bridge_Data());
        ...
        public List<string> Get_Bridge_Data()
        {
            ...
            ASTRA_Data.Add("MEMBER CONNECTIVITY");
            ...
            ASTRA_Data.Add("LOAD  1  DL + SIDL + LL");
