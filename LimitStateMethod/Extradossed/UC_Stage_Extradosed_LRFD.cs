...
{
    public partial class UC_Stage_Extradosed_LRFD : UserControl
    {
        ...
        public UC_Stage_Extradosed_LRFD()
        {
            InitializeComponent();
        }
        ...
        private void txt_steel_pcnt_TextChanged(object sender, EventArgs e)
        {
