...
{
    public partial class frm_Steel_Truss_Warren : Form
    {
        public frm_Steel_Truss_Warren()
        {
            InitializeComponent();
        }
        public frm_Steel_Truss_Warren(IApplication app)
        {
            InitializeComponent();
            this.iApp = app;
        ...
        public frm_Steel_Truss_Warren(IApplication app, bool isWarren2)
        {
            InitializeComponent();
            this.iApp = app;
            user_path = app.LastDesignWorkingFolder;
        ...
        CreateSteel_Warren_1_TrussData truss_data = null;


        CreateSteel_Warren_1_TrussData Bridge_Analysis
        {
            get
            {
                return truss_data;
        ...
        CreateSteel_Warren_2_TrussData Bridge_Analysis_2
        {
            get
            {
                return truss_data2;
        ...
        public void DesignLacing(StreamWriter sw, CMember mbr, double lamda)
        {
            ...
            {
                sw.WriteLine();
                sw.WriteLine("Lacing Angle  1 x {0} {1} x {2}",lbl_ISA.Text, cmb_lac_bl.Text, cmb_lac_tl.Text);
                sw.WriteLine();
            }
        ...
        void Fill_Angles_in_Combobox(ComboBox cmb)
        {
            ...
            for (int i = 0; i < tbl_rolledSteelAngles.List_Table.Count; i++)
            {
                ...
                if (sec_name.Contains("A") && sec_name != "")
                {
        ...
        private void Set_Sections_Standard()
        {
            ...
            switch (cmb_sections_define.SelectedIndex)
            {
                case 0:
                    ...
                    break;
                case 1:
                    pb_sections.BackgroundImage = global::AstraFunctionOne.ImageCollection.section21;
                    cmb_sec_thk.Visible = false;
                    tbl_rolledSteelChannels.Read_Channel_Sections(ref cmb_section_name);
                    cmb_section_name.SelectedIndex = cmb_section_name.Items.Count > 0 ? 0 : -1;
                    break;
                case 2:
                    pb_sections.BackgroundImage = global::AstraFunctionOne.ImageCollection.section31;
                    ...
                    break;
                case 3:
                    pb_sections.BackgroundImage = global::AstraFunctionOne.ImageCollection.section41;
                    cmb_sec_thk.Visible = true;
                    tbl_rolledSteelAngles.Read_Angle_Sections(ref cmb_section_name);
                    cmb_section_name.SelectedIndex = cmb_section_name.Items.Count > 0 ? 0 : -1;
                    txt_no_ele.Text = "4";
        ...
        private void btnProcess_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show(this, "This Process might take few minuites.\n Do you want to continue ?", "ASTRA", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                if (chk_edit_forces.Checked || iApp.DesignStandard == eDesignStandard.BritishStandard)
                    Update_Forces();
                Calculate_Program();
                FillMemberResult();
        ...
        private void frm_Steel_Truss_Warren_Load(object sender, EventArgs e)
        {
            ...
            pic_pier_interactive_diagram.BackgroundImage = AstraFunctionOne.ImageCollection.Pier_Box_drawing;
            ...
            rcc_pier = new RCC_PierDesign(iApp);
            ...
            tabControl4.TabPages.Remove(tab_abutment);
            uC_RCC_Abut1.iApp = iApp;
            ...
            if (iApp.DesignStandard == eDesignStandard.BritishStandard)
            {
                ...
                tab_truss.TabPages.Remove(tab_LL_indian);

                tabControl4.TabPages.Remove(tab_deckslab_IS);
                tabControl4.TabPages.Remove(tab_deckslab_IS1);

            }
            else
            {
                cmb_long_open_file.Items.Add(string.Format("INPUT DATA FILE"));
                //cmb_long_open_file.Items.Add(string.Format("SECTION SUMMARY RESULTS"));
                tab_truss.TabPages.Remove(tab_LL_british);
                tabControl4.TabPages.Remove(tab_deckslab_BS);
            }
            #endregion Chiranjit [2014 09 17]
            ...
            //Chiranjit [2016 08 10] Add Open Project
            //Open_Project();
            Set_Project_Name();
        }
        ...
        private void Open_Project()
        {
            ...
            try
            {
                ...
                if (IsWarren2)
                {
                    ...
                    truss_data2.CreateData(INPUT_FILE);
                }
                else
                {
        ...
        private void btn_cd_open_Click(object sender, EventArgs e)
        {
            if (File.Exists(INPUT_FILE))
                iApp.View_Input_File(INPUT_FILE);
        }
        ...
        private void btn_open_analysis_report_Click(object sender, EventArgs e)
        {
            ...
            if (iApp.DesignStandard == eDesignStandard.BritishStandard)
            {
                File.WriteAllLines(MEMBER_ANALYSIS_RESULT, ana_res.ToArray());
                iApp.View_Result(MEMBER_ANALYSIS_RESULT);
            }
                ...
                do
                {
                    ...
                    if (complete_design.Is_Live_Load && Live_Load_List != null)
                    {
                        ...
                        if (HA_Lanes.Count > 0)
                        {
                            ...
                            {
                                MemberCollection m_crs_g;

                                if (IsWarren2)
                                    m_crs_g = Bridge_Analysis_2.Cross_Girders;
                                else
                                    m_crs_g = Bridge_Analysis.Cross_Girders;


                                foreach (var item in m_crs_g)
                                {
                            ...
                            if(IsWarren2)
                                Bridge_Analysis_2.HA_Loading_Members = MyList.Get_Array_Text(mem_ha);
                            else
                            ...
                            if (IsWarren2)
                                load_lst.Add(string.Format("{0} UNI GY -{1}", Bridge_Analysis_2.HA_Loading_Members, txt_HA_UDL.Text));
                            else
        ...
        private void rbtn_select_analysis_file_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (rbtn_create_analysis_file.Checked && isCreateData)
            {
                //if (!Directory.Exists(user_path))
                //{
                //    SetWorkingFolder();
        ...
        string INPUT_FILE { get { return Path.Combine(user_path, "INPUT_DATA.TXT"); } }
        string MEMBER_ANALYSIS_RESULT { get { return Path.Combine(user_path, "MEMBER_ANALYSIS_RESULT.TXT"); } }
        ...
        private void btn_Create_Data_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (truss_data2.CreateData(INPUT_FILE))
                {
                    ...
                    //MessageBox.Show(this, "Analysis Input data is created as \n\n\r \"ANALYSIS OF STEEL TRUSS BRIDGE WARREN 2\\INPUT_DATA.TXT\" inside the working folder");
        ...
        private void txt_panel_nos_TextChanged(object sender, EventArgs e)
        {
            ...
            uC_Deckslab_BS1.girder_no = MyList.StringToDouble(txt_stringers_nos.Text, 1.0);
        ...
        private void btn_RccPier_Process_Click(object sender, EventArgs e)
        {
            ...
            {
                if (rcc_pier == null) rcc_pier = new RCC_PierDesign(iApp);
                rcc_pier.FilePath = user_path;
        ...
        private void Text_Changed()
        {
            ...
            uC_RCC_Abut1.Length = MyList.StringToDouble(txt_Panel_Length.Text, 0.0);
            uC_RCC_Abut1.Width = MyList.StringToDouble(txt_B.Text, 0.0);
        ...
        private void txt_panel_Width_TextChanged_1(object sender, EventArgs e)
        {
            txt_w.Text = (MyList.StringToDouble(txt_panel_Width.Text, 0.0) * 1000).ToString();
        ...
        eASTRADesignType Project_Type
        {
            ...
            {
                if(IsWarren2)
                    return eASTRADesignType.Steel_Truss_Bridge_Warren_2;
