...
{
    public partial class frm_Steel_Truss_Warren3 : Form
    {
        public frm_Steel_Truss_Warren3()
        {
            InitializeComponent();
        }
        public frm_Steel_Truss_Warren3(IApplication app)
        {
            InitializeComponent();
            this.iApp = app;
        ...
        CreateSteel_Warren_3_TrussData truss_data = null;


        CreateSteel_Warren_3_TrussData Bridge_Analysis
        {
            get
            {
                return truss_data;
        ...
        void Button_Enable_Disable()
        {
            try
            {
                btn_view_structure_1.Enabled = File.Exists(INPUT_FILE);
        ...
        private void Open_Project()
        {
            ...
            try
            {
                ...
                {
                    truss_data = new CreateSteel_Warren_3_TrussData();
        ...
        eASTRADesignType Project_Type
        {
            get
            {
                return eASTRADesignType.Steel_Truss_Bridge_Warren_3;
            }
        }
